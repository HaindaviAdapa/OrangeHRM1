...
public static String username_sendkey="//input[@placeholder='Username']";
public static String password_sendkey="//input[@placeholder='Password']";
public static String login_click="//button[@type='submit']";
