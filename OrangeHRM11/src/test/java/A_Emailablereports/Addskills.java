...
public class Addskills {
  ...
  public void openorangehrm()
  {
   ...
   public void add_skills() 
   {
	   ...
	   driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("Oracle 2188");
	   driver.findElement(By.xpath("//textarea[ @placeholder='Type description here']")).sendKeys("Oracle 2188 descr");
