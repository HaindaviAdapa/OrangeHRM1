...
public class TC04_Login_DataProvider {
	...
	public void Login_Test(String TestURL,String UserName,String Password,String NationalityTex  ) throws Exception
	{
		
		TC04_Login_DataProvider TN1= new TC04_Login_DataProvider();
