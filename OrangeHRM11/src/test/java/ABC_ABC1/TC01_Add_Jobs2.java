...
public class TC01_Add_Jobs2 {
  ...
  public static void Add_jobs() throws Exception {
		...
		findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("Sales2");
		findElement(By.xpath("//textarea[@placeholder='Type description here']")).sendKeys("Sales2 descr");
		findElement(By.xpath("//textarea[@placeholder='Add note']")).sendKeys("Sales2 Note");
